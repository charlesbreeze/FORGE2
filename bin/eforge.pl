...
# EDH:  For a worker thread given a subset of the total random picks
#my ($subset_num_probes_in_random_picks, $subset_warnings, @subset_pick_overlaps) = worker_random_picks( $random_picks, $index0, $indexN); 
